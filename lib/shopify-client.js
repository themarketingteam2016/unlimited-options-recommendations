/**
 * @deprecated This client uses a hardcoded shop domain and is insecure for multi-merchant apps.
 * Use the authenticated shopifyClient from req.session instead:
 *
...
export const shopifyAdmin = {
  async request(query, options = {}) {
    console.warn('[shopifyAdmin] DEPRECATED: This client uses hardcoded shop domain. Use req.session.shopifyClient instead.');
