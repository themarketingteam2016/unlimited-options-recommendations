...
export async function syncVariantToShopify(variantData, productGid) {
  try {
    ...
    const mutation = `
      mutation productVariantCreate($productId: ID!, $price: String!, $sku: String, $options: [String!]!, $inventoryQuantities: [InventoryLevelInput!]) {
    ...
    const variables = {
      ...
      inventoryQuantities: [{
        ...
        locationId: 'gid://shopify/Location/94761009404'
      }]
    };
